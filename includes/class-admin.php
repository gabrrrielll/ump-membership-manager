...
class UMP_MM_Admin {
	...
	public function add_admin_menu() {
		...
		// Use priority to ensure IHC menu is already registered
		add_submenu_page(
			'ihc_manage',
	...
	public function enqueue_scripts( $hook ) {
		...
		if ( 'ultimate-membership-pro_page_ump-membership-manager' !== $hook && 
			 'toplevel_page_ump-membership-manager' !== $hook &&
			 strpos( $hook, 'ump-membership-manager' ) === false ) {
			return;
		}
